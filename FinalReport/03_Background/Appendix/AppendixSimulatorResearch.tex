...
\begin{figure}[H]
    ...
    \source{\url{https://www.4d-virtualiz.com/en/automotive-simulator}}
\end{figure}
...
\begin{figure}[H]
    ...
    \source{\url{https://microsoft.github.io/AirSim}}
\end{figure}
...
\begin{figure}[H]
    ...
    \source{Slide deck from Apollo Game Engine Based Simulation Talk at GDC 2019 - \url{https://bit.ly/2VSzwlF}}
\end{figure}
...
\begin{figure}[H]
    ...
    \source{\url{https://www.unrealengine.com/en-US/spotlights/carla-democratizes-autonomous-vehicle-r-d-with-free-open-source-simulator}}
\end{figure}


%%%%%%%% CoppeliaSim %%%%%%%%%%
\subsection{CoppeliaSim} \label{CoppeliaSim}
...
\begin{figure}[H]
    ...
    \source{\url{https://www.youtube.com/watch?v=MrwU6wJNTAc&t=23s}}
\end{figure}
...
\begin{figure}[H]
    ...
    \source{\url{https://crowdsim3d.com}}
\end{figure}
...
\begin{figure}[H]
    ...
    \source{\url{https://deepdrive.voyage.auto}}
\end{figure}
...
\begin{figure}[H]
    ...
    \source{\url{https://docs.donkeycar.com}}
\end{figure}
...
\begin{figure}[H]
    ...
    \source{\url{http://gazebosim.org/blog/vehicle\%20simulation}}
\end{figure}
...
\begin{figure}[H]
    ...
    \source{\url{https://itp.uni-frankfurt.de/~gros/StudentProjects/Robots\_2016\_ObstacleAvoidance}}
\end{figure}
...
\begin{figure}[H]
    ...
    \source{\url{https://www.lgsvlsimulator.com/about}}
\end{figure}
...
\begin{figure}[H]
    ...
    \source{\url{http://www.anykode.com/downloads.php}}
\end{figure}
...
\begin{figure}[H]
    ...
    \source{\url{http:https://www.rfpro.com/driving-simulation}}
\end{figure}
...
\begin{figure}[H]
    ...
    \source{\url{https://docs.rigsofrods.org/gameplay/beginners-guide}}
\end{figure}
...
\begin{figure}[H]
    ...
    \source{\url{https://sourceforge.net/projects/torcs}}
\end{figure}
...
\begin{figure}[H]
    ...
    \source{\url{https://www.cyberbotics.com/doc/automobile/city-night}}
\end{figure}
